...
\usepackage[range-phrase = --,range-units=single,mode=text,round-precision=2,separate-uncertainty = true, mode = math]{siunitx}
\usepackage[table,xcdraw]{xcolor}
% \usepackage[protrusion=true,expansion=true]{microtype} % Minion Pro sometimes causes word stretching. Ensure proper hyphenation:
\usepackage[libertine]{newtxmath} % so much better math font. Works very nicely with the minion pro
\usepackage{nameref}

\usepackage{tikz}
\usetikzlibrary{shadows.blur}
\usepackage{scrlayer-scrpage}
\usepackage{atbegshi} % for adding overlay per page
\usepackage{everypage}
%% johan works required packages
\usepackage{float} % used in Johan's work, for table [H] thing.
