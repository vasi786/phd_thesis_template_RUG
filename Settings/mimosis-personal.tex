...
\KOMAoptions
  {
    ...
    twoside=semi,      % a digital copy is of course not two-sided! So set this to 'false' for the digital reading version for the comittee, and turn it to 'true' or 'semi' for the printing copy you need to send to the press. See below for difference between true and semi.
...
% If twoside = true, this has the (seemingly) weird effect of getting much larger empty margin space on the outer edges then the inner edges of the paper, but this actually sort of makes sense!
% Since this will be a booklet, the two inner margins together will actually be the same size as the individual outer margins. If you don't like the way this looks (like me), set this to `semi`, and the margins will look normal.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Draft settings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Turn these off for the final version!
% It draws a black vertical line in the margin next to any line of text that extends past the right margin.
...
\definecolor{canaryyellow}          {RGB}{255, 239, 0}
\definecolor{patrickpurple}         {RGB}{62, 15, 97}
\definecolor{storange}              {RGB}{203,105,63}
...
\def\colourarray{{"deep-azure", "patrickpurple", "deep-azure", "rugred", "storange", "britishracinggreen", "black", "darktangerine", "tpyellow", "tpred", "tpdblue", "tpgreen"}}
...
% chapter naming not all captials
\setkomafont{chapter}{\normalfont\Huge}
...
\ohead*{\footnotesize \leftmark}    % Header: dynamic section info
%\ofoot*{\footnotesize Chapter \thechapter~|~\pagemark}  % Footer: chapter + page
\ofoot*{\footnotesize
